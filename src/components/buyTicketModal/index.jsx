                ...
                <div className="buy-form">
                    ...
                    <div className="buy-form-body">
                        <div className="buy-form-body-inputs">
                            <span>País</span><input  value={country} onChange={(e) => setCountry(e.target.value) }/>
                            <span>Dirección</span><input value={street} onChange={(e) => setStreet(e.target.value) }/>
                            <span>Ciudad</span><input value={city} onChange={(e) => setCity(e.target.value) }/>
                            <span>Código postal</span><input value={postalCode} onChange={(e) => setPostalCode(e.target.value) }/>
                            <span>Provincia</span><input value={region} onChange={(e) => setRegion(e.target.value) }/>
                            <span>Número targeta</span><input value={targetNum} onChange={(e) => setTargetNum(e.target.value) }/>
                            <span>Fecha caducidad</span><input value={date} onChange={(e) => setDate(e.target.value) } type="date"/>
                            <span>CVV</span><input value={cvv} onChange={(e) => setCvv(e.target.value) }/>
                        </div>
                    </div>
